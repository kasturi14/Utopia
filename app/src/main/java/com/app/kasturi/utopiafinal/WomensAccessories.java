...
public class WomensAccessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Womens_accessories");
        ...
        CustomAdapter customAdapter = new CustomAdapter(WomensAccessories.this, images, Names, prices);
