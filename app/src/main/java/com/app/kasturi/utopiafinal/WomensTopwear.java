...
public class WomensTopwear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Womens_topwear");
        ...
        CustomAdapter customAdapter = new CustomAdapter(WomensTopwear.this, images, Names, prices);
