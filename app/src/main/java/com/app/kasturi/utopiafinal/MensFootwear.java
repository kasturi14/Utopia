...
public class MensFootwear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Men_footwear");
        ...
        CustomAdapter customAdapter = new CustomAdapter(MensFootwear.this, images, Names, prices);
