...
public class MensAccessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Men_accessories");
        ...
        CustomAdapter customAdapter = new CustomAdapter(MensAccessories.this, images, Names, prices);
