...
public class MensBottomwear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Men_bottomwear");
        ...
        CustomAdapter customAdapter = new CustomAdapter(MensBottomwear.this, images, Names, prices);
