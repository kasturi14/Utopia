...
public class WomensFootwear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Womens_footwear");
        ...
        CustomAdapter customAdapter = new CustomAdapter(WomensFootwear.this, images, Names, prices);
