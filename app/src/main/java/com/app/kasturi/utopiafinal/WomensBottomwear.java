...
public class WomensBottomwear extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            JSONArray userArray = obj.getJSONArray("Womens_bottomwear");
        ...
        CustomAdapter customAdapter = new CustomAdapter(WomensBottomwear.this, images, Names, prices);
